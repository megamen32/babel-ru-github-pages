...
;
const metadata = {
    title: "Русская Библиотека Вавилона",
    description: "Русская Библиотека Вавилона: координаты, зал, стена, полка, том, страница, base64url. Один алгоритм ru1: настоящая координатная библиотека без хранения страниц.",
    icons: {
        icon: "data:,"
    }
};
